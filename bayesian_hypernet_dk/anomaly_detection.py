...
from bayesian_hypernet_dk.helpers import flatten_list, gelu, plot_dict
from bayesian_hypernet_dk.helpers import log_normal, log_stdnormal
from bayesian_hypernet_dk.helpers import load_mnist

from bayesian_hypernet_dk.layers import LinearFlowLayer, IndexLayer, PermuteLayer, ReverseLayer
from bayesian_hypernet_dk.layers import CoupledDenseLayer, stochasticDenseLayer2, ConvexBiasLayer#, CoupledWNDenseLayer
from bayesian_hypernet_dk.layers import * # just in case
...
if 1: # extra imports, collected from throughout the script...
    ...
    from bayesian_hypernet_dk.helpers import MCpred
...
if anomaly:
    ...
    try:
        ...
        from bayesian_hypernet_dk.helpers import load_data10
